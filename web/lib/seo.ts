  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ...
        en: `/en${path}` || '/en',
        uk: `/uk${path}` || '/uk',
        /* x-default — версия для тех, чей язык не совпал ни с одной из трёх.
           Это английская: русская остаётся в корне (адреса менять нельзя,
           индекс копился на них), но по охвату запросов главная у нас
           английская, а следом украинская. */
        'x-default': `/en${path}` || '/en',
      },
    },
    robots: index
