      ...
      <section className="shell" id="pricing">
        ...
        <div className="pgrid">
          <article className="pl">
            ...
            <ul><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.free.ticks[0]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.free.ticks[1]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.free.ticks[2]}</li></ul>
          </article>
          <article className="pl on">
            ...
            <ul><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.standard.ticks[0]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.standard.ticks[1]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.standard.ticks[2]}</li></ul>
          </article>
          <article className="pl">
            ...
            <ul><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.large.ticks[0]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.large.ticks[1]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.large.ticks[2]}</li></ul>
          </article>
          <article className="pl">
            ...
            <ul><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.business.ticks[0]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.business.ticks[1]}</li><li><svg aria-hidden="true"><use href="#ck" /></svg>{t.business.ticks[2]}</li></ul>
          </article>
        </div>
      </section>
    </>
