  ...
  return (
    <>
      <section className="shell final">
        ...
        <div className="btns">
          <a className="btn btn-p" href={href(lang, '/')}>{t.start}<svg style={{ width: '16px', height: '16px' }}><use href="#ar" /></svg></a>
          <a className="btn btn-g" href="https://github.com/Anton-Babaskin/MoveMailbox/releases/tag/v0.4.0-preview" target="_blank" rel="noreferrer"><svg style={{ width: '16px', height: '16px' }}><use href="#dl" /></svg>{t.download}</a>
        </div>
        <small>{t.small}</small>
      </section>
    </>
