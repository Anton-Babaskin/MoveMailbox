...
export const desktopApp = {
  ru: {
    ...
    mockTitle: 'Локальный режим',
    mockNote: 'копирование идёт на вашем компьютере',
  ...
  en: {
    ...
    mockTitle: 'Local mode',
    mockNote: 'the copying runs on your own computer',
  ...
  uk: {
    ...
    mockTitle: 'Локальний режим',
    mockNote: 'копіювання відбувається на вашому комп’ютері',
